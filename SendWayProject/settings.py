"""
Django settings for SendWayProject project.
...
SECRET_KEY = 'django-insecure-c9@hq^4zznc^n^q1e2#t(vt)j10z-8)xw7623i$!e)eqz(so(c'
...
ROOT_URLCONF = 'SendWayProject.urls'
...
WSGI_APPLICATION = 'SendWayProject.wsgi.application'
